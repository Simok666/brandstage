...
@section('title', 'Brands Second Sections')
@section('title_page', 'Brands Second Sections')
@section('desc_page', 'Edit Content Brands Second Sections')
@section('styles')
...
<div class="card">
    <div class="card-header">
        ...
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori">Add Brands Second Sections</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'brands_second_sections' , 'url' => '/api/v1/admin/brandsSecondSection' , 'headers' => [
            "Heading First Text",
            "Heading Strong Text",
            "Heading Second Text",
            "Action"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel4">Add Brands-Second-Section</h4>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td >
                                    ...
                                    <textarea type="text" name="repeater[0][heading_first_text]" class="form-control sumernote-perpustakaan-edit" data-bind-heading_first_text value="" rows="3">  </textarea>
                            ...
                            <tr>
                                <th>Heading Strong Text</th>
                                <td >
                                    <textarea type="text" name="repeater[0][heading_strong_text]" class="form-control sumernote-perpustakaan-edit" data-bind-heading_strong_text value="" rows="3">  </textarea>
                            ...
                            <tr>
                                <th>Heading Second Text</th>
                                <td >
                                <textarea type="text" name="repeater[0][heading_second_text]" class="form-control sumernote-perpustakaan-edit" data-bind-heading_second_text value="" rows="3">  </textarea>
                            ...
                            <tr>
                                <th>Heading Underlined First Text</th>
                                <td >
                                <textarea type="text" name="repeater[0][heading_underlined_first_text]" class="form-control sumernote-perpustakaan-edit" data-bind-heading_underlined_first_text value="" rows="3">  </textarea>
                            ...
                            <tr>
                                <th>Heading Third Text</th>
                                <td >
                                <textarea type="text" name="repeater[0][heading_third_text]" class="form-control sumernote-perpustakaan-edit" data-bind-heading_third_text value="" rows="3">  </textarea>
                            ...
                            <tr>
                                <th>Heading Underlined Second Text</th>
                                <td >
                                <textarea type="text" name="repeater[0][heading_underlined_second_text]" class="form-control sumernote-perpustakaan-edit" data-bind-heading_underlined_second_text value="" rows="3">  </textarea>
                            ...
                            <tr>
                                <th>Heading Fourth Text</th>
                                <td >
                                <textarea type="text" name="repeater[0][heading_fourth_text]" class="form-control sumernote-perpustakaan-edit" data-bind-heading_fourth_text value="" rows="3">  </textarea>
...
<script>
    $(document).ready(function() {
        GetData(req,"brands_second_sections", formatbrandsecondsection);
    });

    function formatbrandsecondsection(data) {
        var result = "";
    ...
    $("#form-add-kategori").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateSecondSection`;
    ...
    $(document).on('click', '.btn-detail', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/brandsSecondSection`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
