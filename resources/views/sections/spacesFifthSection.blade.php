...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Fifth Section Heading Description</h4>
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori">Add Spaces Fifth Heading Description</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'space_fifth_section_heading_descriptions' , 'url' => '/api/v1/admin/spacesFifthSectionHeadingDescription' , 'headers' => [
            "Heading",
            "Description",
            "Action"
        ] , 'pagination' => true])
...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Fifth Section FAQ</h4>
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori-2">Add Spaces Fifth FAQ</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'space_fifth_section_f_a_q_s' , 'url' => '/api/v1/admin/spacesFifthSectionFAQ' , 'headers' => [
            "Question",
            "Answer",
            "Action"
        ] , 'pagination' => true])
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel4">Add Spaces-
                    Fifth-Section-Heading-Description
                </h4>
        ...
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title white" id="">
                    Edit Spaces-Fifth-Section-Heading-Description
                </h5>
                <button type="button" class="close" data-bs-dismiss="modal"
                    aria-label="Close">
                    <i data-feather="x"></i>
...
<script>
    ...
    $("#form-add-kategori").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateSpacesFifthSectionHeadingDescription`;
    ...
    $("#form-add-kategori-2").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateSpacesFifthSectionFAQ`;
        const data = new FormData(this);
        loadingButton($(this))
        ajaxDataFile(url, 'POST', data, function(resp) {
            toast("Data has been saved");
    ...
    $(document).on('click', '.btn-edit', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/spacesFifthSectionHeadingDescription`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
    ...
    $(document).on('click', '.btn-edit-2', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/spacesFifthSectionFAQ`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
