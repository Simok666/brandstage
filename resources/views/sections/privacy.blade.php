...
@section('title', 'Privacy Edit Page')
@section('title_page', 'Privacy Edit Page')
@section('desc_page', 'Edit Content Privacy Page')
@section('styles')
...
<div class="card">
    <div class="card-header">
        ...
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori">Add Privacy</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'privacies' , 'url' => '/api/v1/admin/privacy' , 'headers' => [
           "List Heading",
           "List Description",
           "Action"
        ] , 'pagination' => true])
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel4">Add Data Privacy</h4>
...
<script>
    $(document).ready(function() {
        GetData(req,"privacies", formatprivacies);
    });

    function formatprivacies(data) {
    ...
    $(document).on('click', '.btn-delete', function() {
                ...
                const url = `${baseUrl}/api/v1/admin/deletePrivacy`;
                ajaxData(url, 'POST', {
                    "id": id,
                }, function(resp) {
                    toast(resp.message);
    ...
    $("#form-add-kategori").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdatePrivacy`;
    ...
    $(document).on('click', '.btn-edit', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/privacy`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
