...
@section('title', 'Brands Fourth Section')
@section('title_page', 'Brands Fourth Section')
@section('desc_page', 'Edit Content Brands Fourth Section')
@section('styles')
...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Fourth Section Heading Buttons</h4>
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori">Add Brands Fourth Heading Button</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'brands_fourth_section_heading_buttons' , 'url' => '/api/v1/admin/brandsFourthSectionHeadingButton' , 'headers' => [
            "Heading",
            "Button Title",
            "Button Link",
            "Action"
...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Fourth Section Icon Description</h4>
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori-2">Add Brands Fourth Icon Description</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'brands_fourth_section_icon_descriptions' , 'url' => '/api/v1/admin/brandsFourthSectionIconDescription' , 'headers' => [
            "Heading",
            "Description",
            "Icon Image",
            "Action"
...
<div class="modal fade text-left" id="modal-add-kategori-2" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel4">Add Brands-
                    Fourth-Section-Icon-Description
                </h4>
                <button type="button" class="close" data-bs-dismiss="modal"
                    aria-label="Close">
                    <i data-feather="x"></i>
        ...
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title white" id="">
                    Edit Brands-Fourth-Section-Heading-Button
                </h5>
                <button type="button" class="close" data-bs-dismiss="modal"
                    aria-label="Close">
                    <i data-feather="x"></i>
...
<div class="modal fade text-left" id="editKategori-2" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable"
        ...
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title white" id="">
                    Edit Brands-Fourth-Section-Icon-Description
                </h5>
                <button type="button" class="close" data-bs-dismiss="modal"
                    aria-label="Close">
                    <i data-feather="x"></i>
...
<script>
    $(document).ready(function() {
        ...
        GetData(req,"brands_fourth_section_heading_buttons", formatbrandfourthheadingbutton);
        GetData(req,"brands_fourth_section_icon_descriptions", formatbrandfourthicondescription);
    });
    function formatbrandfourthicondescription(data) {
        var result = "";
    ...
    function formatbrandfourthheadingbutton(data) {
        var result = "";
        $.each(data, function(index, data) {
    ...
    $("#form-add-kategori").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateFourthSectionHeadingButton`;
    ...
    $("#form-add-kategori-2").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateFourthSectionIconDescription`;
        const data = new FormData(this);
        loadingButton($(this))
        ajaxDataFile(url, 'POST', data, function(resp) {
            toast("Data has been saved");
    ...
    $(document).on('click', '.btn-edit', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/brandsFourthSectionHeadingButton`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
    ...
    $(document).on('click', '.btn-edit-2', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/brandsFourthSectionIconDescription`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
