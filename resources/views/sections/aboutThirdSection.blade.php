...
@section('title', 'About Third Section')
@section('title_page', 'Abotu Third Section')
@section('desc_page', 'Edit Content About Third Section')
@section('content')
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Third Section Heading Description</h4>
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori">Add About Third Heading Description</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'about_third_section_heading_descriptions' , 'url' => '/api/v1/admin/aboutThirdSectionHeadingDescription' , 'headers' => [
            "Heading",
            "Description",
            "Action"
        ] , 'pagination' => true])
...
<div class="card">
    ...
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'about_third_section_icon_descriptions' , 'url' => '/api/v1/admin/aboutThirdSectionIconDescription' , 'headers' => [
            "Heading",
            "Description",
            "Icon Image",
            "Action"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel4">Add About-
                    Third-Section-Heading-Description
                </h4>
...
<div class="modal fade text-left" id="modal-add-kategori-2" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel4">Add About-
                    Third-Section-Icon-Description
                </h4>
                <button type="button" class="close" data-bs-dismiss="modal"
                    aria-label="Close">
                    <i data-feather="x"></i>
        ...
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title white" id="">
                    Edit About-Third-Section-Heading-Description
                </h5>
                <button type="button" class="close" data-bs-dismiss="modal"
                    aria-label="Close">
                    <i data-feather="x"></i>
...
<div class="modal fade text-left" id="editKategori-2" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable"
        ...
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title white" id="">
                    Edit About-Third-Section-Icon-Description
                </h5>
                <button type="button" class="close" data-bs-dismiss="modal"
                    aria-label="Close">
                    <i data-feather="x"></i>
...
<script>
    $(document).ready(function() {
        ...
        GetData(req,"about_third_section_heading_descriptions", formataboutthirdheadingbutton);
        GetData(req,"about_third_section_icon_descriptions", formataboutthirdicondescription);
    });
    function formataboutthirdicondescription(data) {
        var result = "";
    ...
    function formataboutthirdheadingbutton(data) {
        var result = "";
        $.each(data, function(index, data) {
    ...
    $("#form-add-kategori").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateAboutThirdSectionHeadingDescription`;
    ...
    $("#form-add-kategori-2").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateAboutThirdSectionIconDescription`;
        const data = new FormData(this);
        loadingButton($(this))
        ajaxDataFile(url, 'POST', data, function(resp) {
            toast("Data has been saved");
    ...
    $(document).on('click', '.btn-edit', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/aboutThirdSectionHeadingDescription`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
    ...
    $(document).on('click', '.btn-edit-2', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/aboutThirdSectionIconDescription`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
