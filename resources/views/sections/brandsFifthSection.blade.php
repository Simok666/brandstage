...
@section('title', 'Brands Fifth Section')
@section('title_page', 'Brands Fifth Section')
@section('desc_page', 'Edit Content Brands Fifth Section')
@section('styles')
...
<div class="card">
    <div class="card-header">
        ...
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori">Add Brands Fifth Section</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'brands_fifth_sections' , 'url' => '/api/v1/admin/brandsFifthSection' , 'headers' => [
            "Heading",
            "Button Title",
            "Button Link",
            "Action"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel4">Add Brands-Fifth-Section</h4>
...
<script>
    $(document).ready(function() {
        GetData(req,"brands_fifth_sections", formatfifthsection);
    });

    function formatfifthsection(data) {
        var result = "";
    ...
    $("#form-add-kategori").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateFifthSection`;
    ...
    $(document).on('click', '.btn-detail', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/brandsFifthSection`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
