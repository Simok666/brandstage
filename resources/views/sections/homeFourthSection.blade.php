...
@section('title', 'Home Fourth Section')
@section('title_page', 'Home Fourth Section')
@section('desc_page', 'Edit Content Home Fourth Section')
@section('content')
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Fourth Section Heading</h4>
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori-2">Add Home Fourth Heading</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'home_fourth_heading_sections' , 'url' => '/api/v1/admin/homeFourthHeadingSection' , 'headers' => [
            "Heading",
            "Action"
        ] , 'pagination' => true])
    </div>
...
<div class="card">
    <div class="card-header">
        ...
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori">Add Home Fourth Section</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'home_fourth_sections' , 'url' => '/api/v1/admin/homeFourthSection' , 'headers' => [
            "First Title",
            "Second Title",
            "Image",
            "Action"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel4">Add Home Fourth Section</h4>
                    ...
                    <table class="table table-striped table-komponent after-loading">
                        <tbody>
                            <tr>
                                <th>First Title</th>
                                <td>
                                    <input type="text" name="repeater[0][first_title]" class="form-control" required>
                                </td>
                            </tr>
                            <tr>
                                <th>Second Title</th>
                                <td>
                                    <input type="text" name="repeater[0][second_title]" class="form-control" required> 
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td >
                                    ...
                                    <input type="text" name="repeater[0][first_title]" value="" class="form-control" data-bind-first_title value="">
                                </td>
                            </tr>
                            <tr>
                                <th>Second Title</th>
                                <td >
                                    <input type="text" name="repeater[0][second_title]" value="" class="form-control" data-bind-second_title value="">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">Image</th>
...
<script>
    $(document).ready(function() {
        GetData(req,"home_fourth_sections", formathomefourth);
        GetData(req,"home_fourth_heading_sections", formathomefourthheading);
    });

    function formathomefourth(data) {
        var result = "";
        $.each(data, function(index, data) {
            
            result += `
                <tr>
                    <td>${data.first_title}</td>
    ...
    function formathomefourthheading(data) {
        var result = "";
        $.each(data, function(index, data) {
    ...
    $("#form-add-kategori").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateHomeFourthSection`;
    ...
    $("#form-add-kategori-2").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateHomeFourthHeading`;
        const data = new FormData(this);
        loadingButton($(this))
        ajaxDataFile(url, 'POST', data, function(resp) {
            toast("Data has been saved");
    ...
    $(document).on('click', '.btn-edit', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/homeFourthSection`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
    ...
    $(document).on('click', '.btn-edit-2', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/homeFourthHeadingSection`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
