...
@section('title', 'Brands Hero')
@section('title_page', 'Brands Hero')
@section('desc_page', 'Edit Content Brands Hero')
@section('content')
<div class="card">
    <div class="card-header">
        <h4 class="card-title"></h4>
        <button type="submit" style="float: right" class="btn btn-primary btn-add-kategori">Add Brands Heroes</button>
    </div>
    <div class="card-body">
        @include('components.table-pagination', ['table' => 'brands_heroes' , 'url' => '/api/v1/admin/brandshero' , 'headers' => [
            "Heading",
            "Description",
            "Button Title",
            "Button Link",
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel4">Add Brands-Hero</h4>
...
<script>
    $(document).ready(function() {
        GetData(req,"brands_heroes", formatbrandhero);
    });

    function formatbrandhero(data) {
        var result = "";
    ...
    $("#form-add-kategori").on('submit', function(e) {
        e.preventDefault();
        const url = `${baseUrl}/api/v1/admin/addOrUpdateHero`;
    ...
    $(document).on('click', '.btn-edit', function() {
        ...
        ajaxData(`${baseUrl}/api/v1/admin/brandshero`, 'GET', {
            "id" : $(this).data('id')
        }, function(resp) {
